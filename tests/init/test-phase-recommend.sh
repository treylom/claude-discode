...
OUT_A=$(echo "$ENV_A" | "$ROOT/scripts/claude-discode-init.sh" --recommend --stdin-env)
...
OUT_B=$(echo "$ENV_B" | "$ROOT/scripts/claude-discode-init.sh" --recommend --stdin-env)
...
OUT_C=$(echo "$ENV_C" | "$ROOT/scripts/claude-discode-init.sh" --recommend --stdin-env)
